...
[Variables]
  ...
  [Ar]
    family = SCALAR
    order = FIRST
    initial_condition = 8.1543668e18
  []
...
[GlobalReactions]
  [argon]
    ...
    #  e -> W                         : {1.52*(760/pres)*(Tgas/273.16)*(Te/1.5)*((J/r_cm)^2 + (pi/d_cm)^2)}
    #  Ar+ -> W                       : {1.52*(760/pres)*(Tgas/273.16)*(Te/1.5)*((J/r_cm)^2 + (pi/d_cm)^2)}
    #  Ar2+ -> W                      : {1.52*(760/pres)*(Tgas/273.16)*(Te/1.5)*((J/r_cm)^2 + (pi/d_cm)^2)}'
  []
[]
